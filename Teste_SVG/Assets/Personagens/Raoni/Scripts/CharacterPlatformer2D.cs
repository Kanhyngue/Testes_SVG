...
public class CharacterPlatformer2D : MonoBehaviour
{
    ...
    private void Move(Vector2 deltaMovement)
    {
        ...
        {
            Debug.Log(State.IsCollidingAbove);
            Crouch(State.IsCollidingAbove);
        }
    ...
    {
        var size = new Vector2(_capsuleCollider.size.x * Mathf.Abs(_localScale.x), _capsuleCollider.size.y * Mathf.Abs(_localScale.y)) / 2;
        var center = new Vector2(_capsuleCollider.offset.x * _localScale.x, _capsuleCollider.offset.y * _localScale.y);
